...
- [ ] 2. Create utility and helper function tests
- [ ] 2.1 Implement error.util.spec.ts
...
- [ ] 2.2 Implement local-storage-sync.spec.ts
...
- [ ] 3. Create core service tests
- [ ] 3.1 Implement loading.service.spec.ts
...
- [ ] 3.2 Implement error-notification.service.spec.ts
...
- [ ] 3.3 Implement tmdb.service.spec.ts
...
- [ ] 4. Create HTTP interceptor tests
- [ ] 4.1 Implement loading.interceptor.spec.ts
...
- [ ] 4.2 Implement error.interceptor.spec.ts
...
- [ ] 5. Create error handler tests
- [ ] 5.1 Implement global-error.handler.spec.ts
...
- [ ] 6. Create NgRx state management tests
- [ ] 6.1 Implement auth.actions.spec.ts
...
- [ ] 6.2 Implement auth.reducer.spec.ts
...
- [ ] 6.3 Implement auth.effects.spec.ts
...
- [ ] 6.4 Implement auth.selectors.spec.ts
...
- [ ] 6.5 Implement auth.state.spec.ts
...
- [ ] 7. Create app-level state management tests
- [ ] 7.1 Implement app.reducer.spec.ts
...
- [ ] 7.2 Implement meta-reducers.spec.ts
...
- [ ] 7.3 Implement app.state.spec.ts
...
- [ ] 8.1 Implement auth.component.spec.ts (enhance existing)
...
- [ ] 8.2 Implement spinner.component.spec.ts
...
- [ ] 9. Create configuration and setup tests
- [ ] 9.1 Implement app.config.spec.ts
...
- [ ] 9.2 Implement app.routes.spec.ts
...
- [ ] 9.3 Implement auth.routes.spec.ts
...
- [ ] 10. Create index file tests
- [ ] 10.1 Implement core/index.spec.ts
...
- [ ] 10.2 Implement infrastructure/index.spec.ts
...
- [ ] 10.3 Implement infrastructure/http/index.spec.ts
...
- [ ] 10.4 Implement infrastructure/models/index.spec.ts
...
- [ ] 10.5 Implement features/auth/store/index.spec.ts
...
- [ ] 10.6 Implement store/index.spec.ts
...
- [ ] 11. Create main application tests
- [ ] 11.1 Implement main.spec.ts
...
- [ ] 12. Enhance existing tests for 100% coverage
- [ ] 12.1 Enhance app.spec.ts
...
- [ ] 12.2 Enhance resource.abstract.spec.ts
...
- [ ] 13. Run coverage analysis and fix gaps
- [ ] 13.1 Generate coverage report and identify remaining gaps
...
- [ ] 13.2 Optimize test performance and reliability
